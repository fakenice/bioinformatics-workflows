...
# bioinformatics-workflows &middot; A bioinformatics workflow intelligence Skill
...
**FlowSeq Live Demo**: https://fakenice.github.io/flowseq
...
Visit the [FlowSeq Demo](https://fakenice.github.io/flowseq) to browse all Skill documentation and interactively explore every analysis pipeline.
